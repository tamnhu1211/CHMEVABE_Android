...
public class Spadapter extends RecyclerView.Adapter<Spadapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        MyViewHolder myViewHoler = (MyViewHolder)  holder;

        spmoi Spmoi = array.get(position);
        holder.txtten.setText(Spmoi.getTensp());
        DecimalFormat decimalFormat = new DecimalFormat("###,###,###");
        //holder.txtgia.setText(decimalFormat.format(("Giá:"+Spmoi.getGia()+"Đ")));

        //holder.txtgia.setText("Giá:"+Spmoi.getGia()+"Đ");
        holder.txtgia.setText("Giá:"+decimalFormat.format(Double.parseDouble(Spmoi.getGia()))+".000Đ");
